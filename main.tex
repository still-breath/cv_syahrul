...
\begin{tabularx}{\textwidth}{|>{\centering\arraybackslash}X|>{\centering\arraybackslash}p{8cm}|>{\centering\arraybackslash}p{3cm}|>{\centering\arraybackslash}p{2.5cm}|}
  ...
  \hline
  S.T., Teknik Komputer & Institut Teknologi Sepuluh Nopember, Surabaya & 3.43/4.0 & Aug 2025 \\ 
  \hline
\end{tabularx}
\vspace{-4mm}
...
\resumeHeadingSkillStart
    \resumeSubItem{Full-Stack Development}{: PHP, Laravel, Python, Go (Golang), React.js, Node.js, Express.js, Flask, API, SQL, MongoDB, Three.js, HTML/CSS}
    \resumeSubItem{AI \& IoT Systems}{: PyTorch, TensorRT, YOLO, LSTM, NLP Jetson Nano, ESP32, Arduino, C++, PyQt, RTMP/RTSP Streaming}
    \resumeSubItem{DevOps \& Cloud}{: Git, Docker, Nginx, Vercel, Azure, Apache}
...
\resumeSubheading
    {PT. Aldzama}{Gresik, Indonesia}
    {Software Engineer}{Sep 2025 - Present}
    \resumeItemListStart
        \resumeItemMain{\textbf{ERP \& DevOps:}}
        \resumeItemSub{Set up office \textbf{VPN} and \textbf{on-prem server} environment (PC-based) for secure access and internal deployments.}
        \resumeItemSub{Built and deployed an \textbf{in-house HRIS \& Attendance ERP} as a \textbf{full-stack developer} using \textbf{Laravel}, designed for \textbf{\textasciitilde 600 employees}.}
        \resumeItemSub{Eliminated recurring \textbf{monthly subscription} and \textbf{per-user licensing} costs by replacing paid ERP with an internal platform; enables fast customization aligned with operational needs.}
        \resumeItemSub{Rebuilt the \textbf{company profile website} from scratch using \textbf{React.js} + \textbf{Laravel backend/API}.}
        \resumeItemMain{\textbf{Project Manager:}}
        \resumeItemSub{Leading development of the \textbf{Refractory Maintenance Dashboard} as \textbf{Project Manager} (scope, timeline, stakeholders).}
    \resumeItemListEnd
...
\resumeSubheading
    ...
    \begin{tabular*}{\linewidth}{@{}l@{\extracolsep{\fill}}r@{}}
        \textbf{JAREE ITS (Academic Journal Platform):} & {\footnotesize\textit{July 2025 - Oct 2025}} \\
    ...
    \item
    \begin{tabular*}{\linewidth}{@{}l@{\extracolsep{\fill}}r@{}}
    \textbf{Retrux-Shelf-Eye (AI Inventory Management System):} & {\footnotesize\textit{Aug 2025 - Sep 2025}} \\
    ...
    \item
        ...
        {\footnotesize\textit{Tools:} Python, Flask, ESP32, Express.js, PHP} & %{\footnotesize\href{https://github.com/still-breath/clipper-dashboard-go}{\textcolor{darkblue}{GitHub}}}
        \end{tabular*}
        \vspace{-0.8em}
        \resumeItemListStart
        ...
        {\footnotesize\textit{Tools:} Python, Golang, FastAPI, React.js, Three.js} &% {\footnotesize\href{https://github.com/still-breath/packaging-box-website}{\textcolor{darkblue}{GitHub}}}
        \end{tabular*}
        \vspace{-0.8em}
        \resumeItemListStart
            ...
            \resumeItemSub{Built the full-stack application with \textbf{React.js}, \textbf{FastAPI}, \textbf{Golang} and a \textbf{Three.js} canvas for 3D visualization.}
        \resumeItemListEnd
        \vspace{0.5em}
...
\resumeSubheading
    ...
    \resumeItemListStart
        ...
        \resumeItemSub{Developed and deployed 2 OCR automation with validation step.}
...
\resumeProject
    {Smart Finance App (Personal Finance Management System)}
    {Tools: Go (Golang), React.js, Python, Scikit-learn, PostgreSQL}
    {Sep 2025}
    {{}[\href{https://github.com/still-breath/finance-app-go}
    {\textcolor{darkblue}{\faGithub}}]}
\resumeItemListStart
    \resumeItemMain{Developed a full-stack personal finance management application that helps users track income and expenses with intelligent categorization. The system integrates a Go backend, React frontend, and a Python AI service to provide automatic transaction categorization using machine learning.}
\resumeItemListEnd
